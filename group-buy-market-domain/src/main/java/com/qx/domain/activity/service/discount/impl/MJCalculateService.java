...
public class MJCalculateService extends AbstractDiscountCalculateService {
    ...
    protected BigDecimal doCalculate(BigDecimal originalPrice,
        ...
        String marketExpr = groupBuyDiscount.getMarketExpr(); String[] split = marketExpr.split(Constants.SPLIT);
        BigDecimal x = new BigDecimal(split[0].trim()); BigDecimal y = new BigDecimal(split[1].trim());
        // 不满足最低满减约束，则按照原价
