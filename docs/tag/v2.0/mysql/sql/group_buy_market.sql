...
VALUES (1, 100123, '手写MyBatis拼团活动', '25120208', 0, 1, 2, 600, 1, '2024-12-07 10:19:40', '2026-12-07 10:19:40',
        NULL, NULL, '2024-12-07 10:19:40', '2025-02-16 14:09:17');
...
(
    ...
    `original_price`  decimal(8, 2) NOT NULL COMMENT '原始价格',
    `deduction_price` decimal(8, 2) NOT NULL COMMENT '折扣金额',
    `pay_price`       decimal(8, 2) NOT NULL COMMENT '折扣金额',
